...
/**
 * Contact section - Modern, clean layout
 */
    ...
    <section id="contact" className="py-20 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-8">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">GitHub</span>
              </div>
              <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-2">
                github.com/thilak007
              </p>
              <p className="text-xs text-zinc-400 dark:text-zinc-500">
                View my code
              </p>
          ...
          {/* Location */}
          <div className="mt-8 flex items-center justify-center gap-1.5 text-sm text-zinc-500 dark:text-zinc-400">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
            San Francisco, California · Open to relocation
          </div>
        </motion.div>
      </div>
    </section>
